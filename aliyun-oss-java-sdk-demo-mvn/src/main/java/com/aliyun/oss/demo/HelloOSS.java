...
public class HelloOSS {
    ...
    private static String accessKeyId = "LTAIvqwrlLQZtC4T";
    private static String accessKeySecret = "wVpif8cDB5p6gRuD1WDCUHqosF33J2";

    // Bucket用来管理所存储Object的存储空间，详细描述请参看“开发人员指南 > 基本概念 > OSS基本概念介绍”。
    // Bucket命名规范如下：只能包括小写字母，数字和短横线（-），必须以小写字母或者数字开头，长度必须在3-63字节之间。
    private static String bucketName = "test-bucket2019";
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("index1.jpg");//new ByteArrayInputStream("Hello OSS".getBytes());
            ...
            FileOutputStream out = new FileOutputStream(new File("a.jpg"));
